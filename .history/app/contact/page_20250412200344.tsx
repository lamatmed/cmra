    ...
    >
      <Card className="w-full max-w-2xl shadow-lg rounded-2xl overflow-hidden">
        <CardContent className="p-8">
          <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">اتصل بنا</h1>
          <p className="text-gray-600 text-center mb-6">
            لأي استفسار أو مساعدة، لا تتردد في التواصل معنا:
          </p>
          ...
          <div className="space-y-4 text-center">
            ...
            <p className="flex items-center justify-center text-lg font-medium text-gray-800">
              ...
              <span className="text-blue-600">123 شارع الأمل، أنغولا</span>
            </p>
          </div>
        </CardContent>
      </Card>
