...
const VotePage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        Swal.fire({
          title: 'خطأ',
          text: 'تعذر تحميل بيانات التصويت.',
          icon: 'error',
  ...
  if (!user) {
    return (
      <p className="text-center text-gray-500">
        الوصول محصور على المستخدمين المتصلين.
      </p>
    );
  }
  ...
  return (
    <div dir="rtl" className="max-w-lg mx-auto p-6 text-center">
      <h1 className="text-3xl font-bold mb-6">صوّت لمرشحك</h1>
      ...
      >
        <Card className="shadow-lg rounded-xl border border-gray-200 p-4">
          <CardHeader>
            <CardTitle>اختر خيارك:</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            {results.choices.length === 0 ? (
              <p>لا توجد خيارات تصويت متاحة.</p>
            ) : (
        ...
        <Card className="mt-6 shadow-md border border-gray-200 p-4">
          <CardHeader>
            <CardTitle>نتائج التصويت</CardTitle>
          </CardHeader>
          <CardContent>
