...
import prisma from "@/lib/prisma"; // Assure-toi d'importer Prisma
...
// Cette fonction est exécutée côté serveur avant que la page ne soit rendue
export async function getServerSideProps() {
  const activities = await prisma.activity.findMany({
    orderBy: { date: 'asc' },
  });

  // Renvoie les données comme props au composant
  return {
    props: {
      activities,
    },
