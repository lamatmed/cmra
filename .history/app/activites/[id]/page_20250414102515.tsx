...
// Fonction pour récupérer les props statiques
...
const ActivityDetailsPage = ({ activity }: { activity: any }) => {
    if (!activity) {
        return notFound(); // Si l'activité n'est pas trouvée, renvoyer la page 404
    }
