  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.ok && auth) {
        ...
        toast({ title: "تم تسجيل الدخول بنجاح", description: "مرحبًا بك!" });
        router.push("/dashboard");

        // عرض تنبيه SweetAlert عند تسجيل الدخول بنجاح
        Swal.fire({
          title: "نجاح",
        ...
        // عرض تنبيه SweetAlert في حالة حدوث خطأ في تسجيل الدخول
        Swal.fire({
          title: "خطأ",
          text: data.message,
          icon: "error",
        ...
        <Card className="shadow-lg rounded-lg bg-white ">
          <CardHeader>
            <CardTitle className="text-blue-700 text-center flex items-center justify-center gap-2">
              <LogIn className="w-6 h-6 text-blue-700" /> اتصال
            </CardTitle>
