...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok)
        throw new Error("فشل التسجيل، المستخدم موجود بالفعل");
  ...
  return (
    <motion.div
      className="flex justify-center items-center min-h-screen bg-gradient-to-r from-green-600 via-emerald-500 to-lime-400 p-4"
      ...
      <Card className="w-full max-w-md shadow-lg bg-white rounded-xl">
        <CardHeader>
          ...
          <CardDescription className="text-center text-black">
            املأ جميع المعلومات لإنشاء حسابك
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            {step === 2 && (
              <>
                ...
                <div className="relative">
                  ...
                  <Textarea
                    name="cv"
                    placeholder="صف بإيجاز خلفيتك المهنية ..."
                    onChange={handleChange}
